...
/* Version Tag */
#include "freetype.library_rev.h"
...
{
    struct FreetypeLibrary *libBase = (struct FreetypeLibrary *)Self->Data.LibBase; 
...
STATIC struct Library *libInit(struct Library *LibraryBase, APTR seglist, struct Interface *exec)
{
    ...
    struct FreetypeLibrary *libBase = (struct FreetypeLibrary *)LibraryBase;
    ...
    libBase->libNode.lib_Node.ln_Name = "freetype.library";
...
{
	{ CLT_DataSize,		sizeof(struct FreetypeLibrary)	},
