...
struct FreetypeLibrary *FreetypeBase = NULL;
static struct FreetypeLibrary *__FreetypeBase;

/****************************************************************************/

void freetype_base_constructor(void)
{
    if (FreetypeBase != NULL)
    {
...
__attribute__((section(".ctors.zzzz"))) static void (*freetype_base_constructor_ptr)(void) USED = freetype_base_constructor;

/****************************************************************************/

void freetype_base_destructor(void)
{
    if (__FreetypeBase)
    {
...
__attribute__((section(".dtors.zzzz"))) static void (*freetype_base_destructor_ptr)(void) USED = freetype_base_destructor;
